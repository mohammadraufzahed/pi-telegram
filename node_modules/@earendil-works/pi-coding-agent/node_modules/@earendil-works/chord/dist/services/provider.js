...
function recordSnapshotSequences(sequences, instances) {
    for (const instance of instances) {
        for (const member of instance.members) {
            if (member.kind === "state")
                sequences.set(stateMemberKey(instance.instance, member.name), member.sequence);
        }
    }
}
function updateCoveredBySnapshot(sequences, update) {
    switch (update.type) {
        case "state": {
...
function stateMemberKey(instance, member) {
